export function ComposerJumpLatestButton({
  ...
  return (
    <div className="absolute left-1/2 top-0 z-[90] inline-flex h-11 min-w-[7rem] -translate-x-1/2 -translate-y-full items-end justify-center bg-transparent pb-1 touch-manipulation sm:h-10">
      <span className={`thread-jump-latest-badge inline-flex h-5 min-w-[5rem] overflow-hidden rounded-[0.7rem] border shadow-sm transition ${
          followTail

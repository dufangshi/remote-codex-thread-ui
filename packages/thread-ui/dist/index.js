        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: `${composerShellClassName} flex w-full flex-col overflow-hidden rounded-[16px] sm:rounded-[18px]`, children: [
            /* @__PURE__ */ jsxs(InputGroup, { className: graphChatInputGroupClassName, children: [
              !isShellView ? /* @__PURE__ */ jsx3(
                "div",
                {
                  "data-slot": "input-group-control",
                  className: `${composerPromptRegionClassName} relative w-full`,
                  children: /* @__PURE__ */ jsxs("div", { className: graphChatInputClassName, children: [
                    prompt.length === 0 && /* @__PURE__ */ jsx3("span", { className: "pointer-events-none absolute left-3 top-3 text-slate-500 sm:left-4 sm:top-4 dark:text-slate-400", children: promptPlaceholder }),
                    /* @__PURE__ */ jsx3(
                      "div",
                      {
                        ref: promptRef,
                      ...
                      !isShellView && /* @__PURE__ */ jsxs(Fragment, { children: [
                        ...
                        /* @__PURE__ */ jsx3(
                          InputGroupButton,
                          {
                            ...
                            size: "icon-xs",
                            "aria-label": canInterrupt ? interruptLabel : goalComposeMode ? "Set goal" : "Send Prompt",
                            ...
                            disabled: canInterrupt ? false : goalBusy || busy || (activeView === "chat" ? disabled : false),
                            className: `${composerSendButtonClassName} h-9 w-9 rounded-full text-sm font-medium disabled:cursor-not-allowed sm:h-8 sm:w-8 ${canInterrupt ? "ui-action-danger" : sendButtonClassName}`,
                            children: canInterrupt ? /* @__PURE__ */ jsx3(
                              "span",
                              {
                                "aria-hidden": "true",
            ...
            goalComposeMode && !isShellView && /* @__PURE__ */ jsxs("div", { className: "relative z-20 mb-1.5 flex flex-wrap items-center gap-2 rounded-2xl border border-sky-300/25 bg-sky-300/[0.07] px-3 py-2 text-xs text-sky-50 shadow-sm shadow-stone-950/10", children: [
              /* @__PURE__ */ jsx3("span", { className: "font-medium uppercase tracking-[0.16em] text-sky-100/90", children: "Goal" }),
              ...
              goalLocalError ? /* @__PURE__ */ jsx3("span", { className: "min-w-0 flex-1 text-rose-200", children: goalLocalError }) : null,
              /* @__PURE__ */ jsx3(
                "button",
                {
                  type: "button",
...
function GraphChatRoomsRailShell({
  ...
  return /* @__PURE__ */ jsx5(
    "aside",
    {
      className: `thread-graph-rooms-surface thread-rooms-rail fixed inset-y-0 left-0 z-50 flex min-h-0 w-[min(20rem,calc(100vw-2rem))] flex-col border-r border-slate-200/80 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition-transform duration-200 ease-out sm:static sm:z-auto sm:w-auto sm:translate-x-0 sm:rounded-[12px] sm:border sm:shadow-[0_10px_30px_rgba(15,23,42,0.04)] ${mobileOpen ? "translate-x-0" : "pointer-events-none -translate-x-full sm:pointer-events-auto"} ${collapsed ? "thread-ui-rail-collapsed sm:items-center" : ""}`,
      children
    }
  );
}
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs4("div", { className: "mt-1 flex min-w-0 items-center gap-2", children: [
            /* @__PURE__ */ jsx8("p", { className: "min-w-0 flex-1 truncate text-[11px] text-[var(--theme-fg-muted)]", children: workspaceLabel && !currentWorkspaceId ? workspaceLabel : thread.model ?? "No model" }),
            /* @__PURE__ */ jsx8(
              "span",
              {
...
function ThreadCards({
  ...
  return /* @__PURE__ */ jsx8("div", { className: containerClassName, children: /* @__PURE__ */ jsx8("div", { className: "space-y-1", children: threads.map((thread) => /* @__PURE__ */ jsx8(
    ThreadCard,
    {
      thread,
      currentThreadId,
...
function ThreadWorkspaceLayout({
  ...
  function renderRoomsRailContent(collapsed = false) {
    return /* @__PURE__ */ jsx8("div", { className: "flex min-h-0 flex-1 flex-col", children: /* @__PURE__ */ jsxs4("section", { className: "flex min-h-0 flex-1 flex-col", children: [
      ...
      /* @__PURE__ */ jsxs4("div", { className: "min-h-0 flex-1 overflow-y-auto px-1", children: [
                          ...
                          /* @__PURE__ */ jsxs4(
                            "div",
                            {
                              ...
                              children: [
                                ...
                                workspaceReturnHref || onWorkspaceReturn ? /* @__PURE__ */ jsx8(
                                  "a",
                                  {
            ...
            /* @__PURE__ */ jsxs4(GraphChatTopbarShell, { children: [
              /* @__PURE__ */ jsx8("div", { className: "thread-topbar-row flex min-h-12 items-center px-3 py-1.5 sm:min-h-12 sm:px-4", children: /* @__PURE__ */ jsxs4("div", { className: "flex w-full items-center justify-between gap-3 sm:gap-4", children: [
                /* @__PURE__ */ jsxs4("div", { className: "flex min-w-0 items-center gap-2 sm:gap-3", children: [
                  renderMobileTopbarControls && showMobileThreadNavToggle && !mobileRoomsOpen ? /* @__PURE__ */ jsx8(
                    "button",
                    {
                      type: "button",
...
function GraphChatMessageStatusBadge({
  ...
  const className = normalized.includes("running") || normalized.includes("generating") || normalized.includes("steering") ? "ui-status-warning" : normalized.includes("failed") || normalized.includes("error") ? "ui-status-danger" : normalized.includes("accepted") || normalized.includes("complete") ? "ui-status-success" : "ui-status-neutral";
  return /* @__PURE__ */ jsxs13(
    "span",
    {
      ...
      children: [
        normalized.includes("running") || normalized.includes("generating") ? /* @__PURE__ */ jsx20(GraphChatRunningDots, {}) : null,
        status
      ]
    }
  );
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs13(
        "div",
        {
          ...
          children: [
            !isUser ? /* @__PURE__ */ jsxs13("div", { className: "thread-graph-message-header mb-2 flex flex-col gap-1.5 sm:flex-row sm:items-start sm:justify-between sm:gap-3", children: [
              /* @__PURE__ */ jsxs13("div", { className: "flex min-w-0 flex-wrap items-center gap-2", children: [
              ...
              copyButton || timeNode ? /* @__PURE__ */ jsxs13("div", { className: "thread-graph-message-header-actions flex shrink-0 items-center gap-2 sm:pt-1", children: [
                copyButton,
                timeNode
              ] }) : null
            ] }) : null,
...
import { CheckCircle2 as CheckCircle23, Clock3, Loader2 as Loader23, XCircle as XCircle3 } from "lucide-react";
...
function GraphChatPlanStepStatusIcon({ status }) {
  ...
  return /* @__PURE__ */ jsx22(
    Badge,
    {
      ...
      children: normalized === "completed" ? /* @__PURE__ */ jsx22(CheckCircle23, { className: "h-3.5 w-3.5" }) : normalized === "in_progress" ? /* @__PURE__ */ jsx22(Loader23, { className: "h-3.5 w-3.5 animate-spin" }) : normalized === "pending" ? /* @__PURE__ */ jsx22(Clock3, { className: "h-3.5 w-3.5" }) : normalized === "failed" ? /* @__PURE__ */ jsx22(XCircle3, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx22("span", { className: "text-[10px] font-semibold uppercase tracking-[0.14em]", children: "?" })
    }
  );
}
        ...
        children: [
          ...
          details.map((detail) => /* @__PURE__ */ jsxs17(
            "span",
            {
              ...
              children: [
                detail.icon,
                /* @__PURE__ */ jsx24("span", { className: "font-medium text-stone-100", children: detail.tokenCompactValue })
              ]
            },
            detail.id
          ))
...
function ThreadTimelineComponent({
  ...
  const [expandedLooseGroups, setExpandedLooseGroups] = useState9(
    {}
  );
  ...
  const unattachedLiveEntries = useMemo7(
    ...
    /* @__PURE__ */ jsx24("section", { className: `flex min-h-0 flex-1 flex-col ${className}`.trim(), children: /* @__PURE__ */ jsx24(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs17("div", { ref: scrollContentRef, className: "thread-graph-scroll-content", children: [
          ...
          unattachedLiveItems && unattachedLiveItems.length > 0 && /* @__PURE__ */ jsx24("div", { className: "thread-graph-message-section space-y-3 px-3 py-2.5 sm:px-5", children: /* @__PURE__ */ jsx24(
            TimelineHistoryEntries,
            {
...
import { useCallback as useCallback4, useEffect as useEffect11, useMemo as useMemo10, useRef as useRef8, useState as useState11 } from "react";
...
function WorkspaceTreeRow({
  ...
  return /* @__PURE__ */ jsxs28(
    "div",
    {
      className: `thread-graph-tree-row group flex items-center text-sm transition ${selected ? "is-selected bg-slate-950 text-white dark:bg-slate-100 dark:text-[#11141a]" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-[#222733] dark:hover:text-slate-100"}`,
      children: [
        /* @__PURE__ */ jsxs28(
          "button",
          {
        ...
        onDownload && node.kind === "file" ? /* @__PURE__ */ jsx37(
          "button",
          {
            type: "button",
            onClick: () => onDownload(node),
            className: `thread-graph-tree-action mr-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-md transition sm:h-7 sm:w-7 sm:opacity-0 sm:group-hover:opacity-100 sm:focus:opacity-100 ${selected ? "text-white/70 hover:bg-white/10 hover:text-white dark:text-[#11141a]/65 dark:hover:bg-[#11141a]/10 dark:hover:text-[#11141a]" : "text-slate-400 hover:bg-white hover:text-slate-900 dark:text-slate-500 dark:hover:bg-[#1d222c] dark:hover:text-slate-100"}`,
    ...
    /* @__PURE__ */ jsx37("div", { className: "space-y-0.5", children: liveNodes.map((node) => {
      ...
      return /* @__PURE__ */ jsxs28(
        "button",
        {
          ...
          onClick: () => onSelect(node.id),
          className: `thread-graph-tree-row flex min-h-9 w-full items-center gap-2 px-3 py-2 text-left text-sm transition sm:min-h-0 sm:py-1.5 ${selected ? "is-selected bg-slate-950 text-white dark:bg-slate-100 dark:text-[#11141a]" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-[#222733] dark:hover:text-slate-100"}`,
          children: [
            /* @__PURE__ */ jsx37(
              FileCode2,
              {
                className: `h-4 w-4 shrink-0 ${selected ? "text-white dark:text-[#11141a]" : "text-emerald-600 dark:text-emerald-300"}`
              }
            ),
...
import { useCallback as useCallback5, useEffect as useEffect14, useMemo as useMemo12 } from "react";
import {
  addEdge,
  Background,
  Controls,
...
function ExportTranscriptDialog({
  ...
  return createPortal4(
    /* @__PURE__ */ jsxs36("div", { className: "fixed inset-0 z-[96] flex items-center justify-center p-3 sm:p-6", children: [
      /* @__PURE__ */ jsx46(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxs36(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs36("div", { className: "flex items-start justify-between gap-3 border-b border-stone-800 px-5 py-4", children: [
              /* @__PURE__ */ jsxs36("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx46("p", { className: "text-sm font-semibold text-stone-100", children: "Export transcript" }),
                /* @__PURE__ */ jsx46("p", { className: "mt-1 text-xs text-stone-500", children: "Default review copy summarizes command batches and file changes." })
              ] }),
              /* @__PURE__ */ jsx46(
                "button",
                {
            ...
            /* @__PURE__ */ jsxs36("div", { className: "min-h-0 flex-1 overflow-auto px-5 py-4", children: [
              /* @__PURE__ */ jsx46("div", { className: "inline-flex rounded-full border border-stone-700 bg-stone-950/60 p-1", children: [
                ["latest", "Latest 10"],
              ...
              /* @__PURE__ */ jsx46("div", { className: "mt-4 inline-flex rounded-full border border-stone-700 bg-stone-950/60 p-1", children: [
                ["pdf", "PDF"],
                ["html", "HTML"]
              ...
              mode === "selected" ? /* @__PURE__ */ jsxs36("div", { className: "mt-4 rounded-2xl border border-stone-800 bg-stone-950/40", children: [
                /* @__PURE__ */ jsxs36("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b border-stone-800 px-3 py-2.5", children: [
                  /* @__PURE__ */ jsxs36("p", { className: "text-xs text-stone-400", children: [
                    "Selected ",
                ...
                turnsState.status === "loading" ? /* @__PURE__ */ jsx46("p", { className: "px-3 py-6 text-sm text-stone-400", children: "Loading turns..." }) : turnsState.status === "failed" ? /* @__PURE__ */ jsx46("p", { className: "px-3 py-6 text-sm text-rose-100", children: turnsState.error }) : /* @__PURE__ */ jsx46("div", { className: "max-h-80 overflow-auto p-2", children: turns.map((turn) => /* @__PURE__ */ jsxs36(
                  "label",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs36("span", { className: "shrink-0 text-xs font-medium text-stone-300", children: [
                        "Turn ",
                        turn.turnNumber
                      ] }),
                      /* @__PURE__ */ jsx46("span", { className: "shrink-0 text-xs text-stone-500", children: formatTurnTime(turn.startedAt) }),
                      /* @__PURE__ */ jsx46("span", { className: "min-w-0 flex-1 truncate text-left text-stone-200", children: turn.userPromptPreview }),
                      /* @__PURE__ */ jsx46("span", { className: "hidden shrink-0 rounded-full border border-stone-700 px-2 py-0.5 text-[10px] text-stone-400 sm:inline", children: statusLabel2(turn.status) })
                    ]
                  },
                  turn.turnId
                )) })
              ] }) : /* @__PURE__ */ jsx46("p", { className: "mt-4 rounded-2xl border border-stone-800 bg-stone-950/40 px-3 py-3 text-sm text-stone-300", children: "Exports the latest 10 turns in chronological order." }),
              /* @__PURE__ */ jsxs36("div", { className: "mt-4 grid gap-2 text-sm text-stone-300 sm:grid-cols-2", children: [
                /* @__PURE__ */ jsxs36("label", { className: "flex items-center gap-2 rounded-xl border border-stone-800 bg-stone-950/35 px-3 py-2", children: [
                  /* @__PURE__ */ jsx46(
                    "input",
                    {
                      type: "checkbox",
                ...
                /* @__PURE__ */ jsx46("p", { className: "flex items-center rounded-xl border border-stone-800 bg-stone-950/35 px-3 py-2 text-xs text-stone-500", children: format === "html" ? "HTML keeps the chat timeline styling and omits raw command output." : "Review exports keep message text readable and omit tool activity." })
              ] })
            ] }),
            /* @__PURE__ */ jsxs36("div", { className: "flex items-center justify-between gap-3 border-t border-stone-800 px-5 py-4", children: [
              /* @__PURE__ */ jsxs36("p", { className: "min-w-0 text-xs text-stone-500", children: [
                selectedCount,
                " ",
...
function GraphChatThreadChatPanel({
  ...
  const handleTailVisibilityChange = useCallback6(
    (nextIsTailVisible) => {
  ...
  const setComposerHostRefs = useCallback6(
    (node) => {
  ...
  const mobileComposerBottomOffset = isMobileViewport && mobilePromptFocused ? mobileKeyboardInset : 0;
...
function PluginProvider({
  ...
  const setPluginEnabled = useCallback7(
  ...
  const importPluginManifest = useCallback7(
    async (input) => {
  ...
  const uninstallPlugin = useCallback7(
    async (pluginId) => {
  ...
  const renderArtifact = useCallback7(
    (context) => {
      const module = enabledModules.find(
        (entry) => entry.renderArtifact && entry.manifest.capabilities.artifactTypes.some(
          (type) => type.type === context.artifact.type
  ...
  const renderInlineCode = useCallback7(
    (context) => {
      for (const module of enabledModules) {
        for (const renderer of module.inlineCodeRenderers ?? []) {
          if (!renderer.languages.includes(context.language.trim().toLowerCase())) {
  ...
  const hasRendererForArtifact = useCallback7(
  ...
  const getThreadPanels = useCallback7(

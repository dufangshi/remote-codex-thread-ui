...
declare function XyzMoleculeViewer({ source, moleculeId, title, className, screenshotRequestId, onScreenshot, onSelectionChange, }: XyzMoleculeViewerProps): react.JSX.Element;
